<h1 align="center">Projeto Biscoito da Sorte- Explorer Rocketseat</h1>
...
Esse projeto é o Projeto do Stage 05 - Biscoito da Sorte ministrado pela <a href="https://www.rocketseat.com.br/" target="_blank">Rocketseat</a> no programa de formação explorer, com intuito de ensino das tecnologias voltadas para web.

## 🔖 Layout

Você pode visualizar o layout do projeto através [DESSE LINK](https://www.figma.com/file/DD0gVF03xaPxqlkHUhbIGo/Biscoito-da-Sorte-(Community)?node-id=1%3A6&mode=dev). É necessário ter conta no [Figma](https://figma.com) para acessá-lo.
